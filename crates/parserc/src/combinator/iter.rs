...
use crate::{InputStream, Parser, ParserKind};

/// Parser created by [`iter`] function.
pub struct Iter<P, I> {
    parser: P,
    input: Option<I>,
}

impl<P, I, O, E> Iter<P, I>
where
    P: Parser<I, Output = O, Error = E>,
    I: InputStream,
{
    /// Convert Iter into [`InputStream`].
    pub fn into_stream(mut self) -> I {
        self.input.take().unwrap()
    }

    pub fn next(&mut self) -> impl Future<Output = Option<O>> + '_ {
...
pub fn iter<P, I, O, E>(parser: P, input: I) -> Iter<P, I>
where
